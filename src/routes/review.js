...
router.get('/user/listByCaretakerId', middlewares.checkAuthentication, ReviewController.listByMyCaretakerId); // Read a review by Owner Id
router.get('/user/:id', middlewares.checkAuthentication, ReviewController.listByCaretakerId); // Read a review by Owner Id
